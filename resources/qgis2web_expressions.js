...
function exp_unidades_morfoestruturais_1rule0_eval_expression(context) {
    // UNI_MRFSTR = 'Bacia Geologica e Magmatismo Serra Geral'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('UNI_MRFSTR')  == 'Bacia Geologica e Magmatismo Serra Geral');
    } else {
        return (feature.get('UNI_MRFSTR')  == 'Bacia Geologica e Magmatismo Serra Geral');
    }
}
...
function exp_unidades_morfoestruturais_1rule1_eval_expression(context) {
    // UNI_MRFSTR = 'Planicie Costeira'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('UNI_MRFSTR')  == 'Planicie Costeira');
    } else {
        return (feature.get('UNI_MRFSTR')  == 'Planicie Costeira');
    }
}